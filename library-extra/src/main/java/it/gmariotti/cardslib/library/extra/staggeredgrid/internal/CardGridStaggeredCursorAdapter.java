...
public abstract class CardGridStaggeredCursorAdapter extends BaseCardCursorAdapter  {
    ...
    protected static String TAG = "CardGridStaggeredCursorAdapter";
    ...
    public CardGridStaggeredCursorAdapter(Context context) {
        super(context, null, 0);
    }

    protected CardGridStaggeredCursorAdapter(Context context, Cursor c, boolean autoRequery) {
        super(context, c, autoRequery);
    }

    protected CardGridStaggeredCursorAdapter(Context context, Cursor c, int flags) {
